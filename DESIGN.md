...
**Version 2.1** · Last updated 2026-07-30 · Revision history at the end of this document.
...
- **Compliance-ops execution items (decided 2026-07-28; host updated 2026-07-30 after the Vercel migration)** — before private beta: signed subprocessor DPAs (Modal, Supabase, Vercel), subprocessor register + privacy-notice page (`/privacy`, draft-for-counsel), manual DSAR/withdrawal runbook (`docs/DSAR_RUNBOOK.md` — PDPO's 40-day access-request clock binds from the first real user). Before public launch: account-deletion self-service (§11).
