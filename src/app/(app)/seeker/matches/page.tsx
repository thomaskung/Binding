...
export default async function SeekerMatchesPage() {
  ...
  return (
    <main className="jb-fade mx-auto max-w-2xl space-y-5 px-6 py-14">
      <header className="flex flex-col gap-1.5">
        <h1 className="font-heading text-[30px] font-semibold leading-tight tracking-tight">Your matches</h1>
