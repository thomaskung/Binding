...
**Version 2.0** · Last updated 2026-08-03 · Revision history at the end of this document. Companions: DESIGN.md (technical), VISION.md (goals), MEMORY.md (decision log).
...
Domain & Brand: We keep the "Binding" name. We launch under `binding.hk` (HK$250/yr) for MVP and plan to acquire the `.com` after seed/Series A funding closes.
...
| 2.0 | 2026-08-03 | Brand rename: **JumpOnBoard → Binding** (public brand; "JumpOnBoard" was the internal code name and is retired). Domain strategy updated to `binding.hk` for MVP (HK$250/yr) with `.com` deferred. Cyberport CCMF grant application drafted (docs/CCMF-Application-Binding.md) with HK-market, legal-cost, and tech-stack research. |
