...
**Version 2.1** · Last updated 2026-08-03 · Revision history at the end of this document. Companions: DESIGN.md (technical), VISION.md (goals), MEMORY.md (decision log).
...
Domain & Brand: We keep the "Binding" name. We launch under `getbinding.com` for MVP.
...
| 2.0 | 2026-08-03 | Brand rename to **Binding** (the prior working name was retired). Domain strategy: `getbinding.com`. Cyberport CCMF grant application drafted with HK-market, legal-cost, and tech-stack research. |
| 2.1 | 2026-08-03 | Full name purge: all technical identifiers (npm package, Vercel project, staging URL, Modal app/secret names, docker stack) renamed to Binding; CMF application package consolidated into local-only `ccmf-app/` (gitignored). Domain `getbinding.com`. |
