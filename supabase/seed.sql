...
insert into profiles (
  ...
  seeker_tier, recruiter_tier
) values
  (
    '00000000-0000-0000-0000-000000000001', true, false, null, 'Demo Seeker',
    'Senior Backend Engineer', 'Central, Hong Kong',
    array['Go','Postgres','Kubernetes','Distributed Systems','Event-Driven Architecture']::text[],
    array['Fintech','Payments']::text[],
    array['Senior Backend Engineer','Staff Engineer']::text[],
    'senior', 8,
    'Certified Kubernetes Administrator (CKA); AWS Solutions Architect Professional; 1 patent in distributed systems',
    '1 patent · 2 certifications',
  ...
  (
    '00000000-0000-0000-0000-000000000002', false, true, 'Apex Talent Partners', 'Demo Recruiter',
    null, null, '{}'::text[], '{}'::text[], '{}'::text[], null, null, null, null,
    null, null, null, 'free', 'solo'
  );
